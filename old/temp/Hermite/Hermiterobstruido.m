...
Dz=1.5*zl;%/5;   % Tamaño de la ventana en z (distancia a la cual propagar)
...
% figure(3)
% imagesc(phase_unwrap(angle(prop)))
%funcion a propagar
g=HGo;
