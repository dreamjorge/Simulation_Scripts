...
%equation or ray r(z) = mrz*dz+r(z-1) using previous value
  ...
  for point_index = 1 : TotalRays
    ...
    HLr  = HankeleLaguerre(r ,thi,LParametersZi,temporalRay.hankelType);
    HLth = HankeleLaguerre(ri,th ,LParametersZi,temporalRay.hankelType);
    HLz  = HankeleLaguerre(ri,thi,LParametersZ ,temporalRay.hankelType);     
