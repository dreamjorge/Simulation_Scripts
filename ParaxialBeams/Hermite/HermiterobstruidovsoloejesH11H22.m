...
Dz=3*zl;%/5;   % Tamaño de la ventana en z (distancia a la cual propagar)
...
xlabel('$x$','Interpreter','latex','FontSize',28) 
ylabel('$y$','Interpreter','latex','FontSize',28)
%calculamos las pendientes en los ejes--------------%
...
mzx11=mzx11o;  mzx22=mzx22o;
% pendiente de z con respecto a y
mzy11=mzy11o;  mzy22=mzy22o;

% Primer valor de los rayos para x
rxz11(1)=rx11;  rxz22(1)=rx22;
% Primer valor de los
ryz11(1)=ry11; ryz22(1)=ry22;   
...
for ii=2:sizezp(2) %corriendo todos los valores de zp
    ...
    % para x
    rxz11(ii)=rx11;  rxz22(ii)=rx22;
    % para y
    ryz11(ii)=ry11;  ryz22(ii)=ry22;
    ...
    figure(10)
    fig10=figure(10);
    fig10.Name=([' z = ',num2str(z(ii)/(zl/2))]);
    ...
    %Propagacion de la parte de arriba en y=0
    plot(rx11/(sqrt(2)*wo),0,'+','MarkerSize',15,'LineWidth',3,'color','r')
    plot(rx22/(sqrt(2)*wo),0,'+','MarkerSize',15,'LineWidth',3,'color','c')
    %Propagacion de abajo 
    plot(-rx11/(sqrt(2)*wo),0,'+','MarkerSize',15,'LineWidth',3,'color','r')
    plot(-rx22/(sqrt(2)*wo),0,'+','MarkerSize',15,'LineWidth',3,'color','c')
    %Propagacion de las cuatro Hankel en la esquina inferior izquierna
    plot(0,ry11/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','r')
    plot(0,-ry22/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','c')
