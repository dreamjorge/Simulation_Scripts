...
phzxo=unwrap(angle(H2(:,N/2+1)));
phzyo=unwrap(angle(H2(N/2+1,:)));
...
phxz=unwrap(angle(H2xy));
phyz=unwrap(angle(H2xy));
%derivadas para x,y constantes
...
for ii=2:sizezp(2) %corriendo todos los valores de zp a excepcion de z=0
    ...
    % Ondas viajeras out
    line([ ((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo), ((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo)], [-((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo), ((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo)],'color','c','LineWidth',1.5)
    line([-((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo),-((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo)], [-((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo), ((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo)],'color','c','LineWidth',1.5)
    line([ ((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo),-((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo)], [ ((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo), ((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo)],'color','c','LineWidth',1.5)
    line([-((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo), ((1/mxo)*z(ii)+sigmaeHx(1))/(sqrt(2)*wo)], [-((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo),-((1/myo)*z(ii)+sigmaeHy(1))/(sqrt(2)*wo)],'color','c','LineWidth',1.5)
    % Ondas viajeras in-out
    line([ ((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo), ((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo)], [-((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo), ((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo)],'color','r','LineWidth',1.5)
    line([-((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo),-((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo)], [-((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo), ((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo)],'color','r','LineWidth',1.5)
    line([ ((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo),-((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo)], [ ((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo), ((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo)],'color','r','LineWidth',1.5)
    line([-((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo), ((1/mxo)*z(ii)-sigmaeHx(1))/(sqrt(2)*wo)], [-((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo),-((1/myo)*z(ii)-sigmaeHy(1))/(sqrt(2)*wo)],'color','r','LineWidth',1.5)
    % Dibujando circulo de valor esperado
...
for ii=2:sizezp(2) %corriendo todos los valores de sp
    ...
    eHGzx=An.*eHGzx; eNHGzx=An.*eNHGzx;
    eHGzy=Am.*eHGzy; eNHGzy=Am.*eNHGzy;
    % Funciones Hankel 2 en x,y z=cte
    H2z=(eHGzy')*(eHGzx)-i*(eNHGzy')*(eNHGzx);
    %---------------------------------------------------------------------%
    %-------curva para x,y=constante y todo z
    % Las dos soluciones del Elegant Hermite para x e y para z=0
    ...
    eHGyz=Am.*eHGyz; eNHGyz=Am.*eNHGyz;
    %Funciones Hankel de elegant Hermite%
    % Funciones Hankel 2 z=cte y x,y
    H2xy=(eHGyz')*(eHGxz)-i*(eNHGyz')*(eNHGxz);
    % ---Fases
    % fase z constante y todo x,y
    phzx=unwrap(angle(H2z(:,N/2+1)));
