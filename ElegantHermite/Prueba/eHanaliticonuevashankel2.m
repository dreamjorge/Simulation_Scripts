...
Dz=zl*1.6;%/5; % Tamaño de la ventana en z (distancia a la cual propagar)
Nz=2^7+1;          % Número de puntos en z
...
xi=sigmaeH(1); yi=sigmaeH(1);   zi=z;
% Parametros de eHermite
qz=zi+i*zl; 
An=(1+zi.^2/zl^2).^(-(nu+1)/4).*(exp(-(i/2)*(nu+1).*atan(zi./zl)));
Am=(1+zi.^2/zl^2).^(-(mu+1)/4).*(exp(-(i/2)*(mu+1).*atan(zi./zl)));
...
%     plot(ph22xz)
    figure(10)
    fig10=figure(10);
    fig10.Name=([' z = ',num2str(z(ii-1)/(sqrt(2)*wo))]);
...
%     line([-vesperadoy(ii)/(sqrt(2)*wo), vesperadoy(ii)/(sqrt(2)*wo)], [-vesperadox(ii)/(sqrt(2)*wo),-vesperadox(ii)/(sqrt(2)*wo)],'color','m','LineWidth',1.5)
    ...
    plot(rx12/(sqrt(2)*wo),ry12/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','y')
...
%     %esquina superior izquierda
    plot(-rx11/(sqrt(2)*wo),ry11/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','m')
    plot(-rx12/(sqrt(2)*wo),ry12/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','c')
    plot(-rx21/(sqrt(2)*wo),ry21/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','r')
    plot(-rx22/(sqrt(2)*wo),ry22/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','y')
%     %esquina inferior izquierna
    plot(-rx11/(sqrt(2)*wo),-ry11/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','c')
    plot(-rx12/(sqrt(2)*wo),-ry12/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','m')
    plot(-rx21/(sqrt(2)*wo),-ry21/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','y')
    plot(-rx22/(sqrt(2)*wo),-ry22/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','r')
%     %esquina inferior derecha
    plot(rx11/(sqrt(2)*wo),-ry11/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','y')
    plot(rx12/(sqrt(2)*wo),-ry12/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','r')
    plot(rx21/(sqrt(2)*wo),-ry21/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','c')
    plot(rx22/(sqrt(2)*wo),-ry22/(sqrt(2)*wo),'+','MarkerSize',15,'LineWidth',3,'color','m')
    text(-5.5,5.5,[' z = ',num2str(2*z(ii-1)/zl)],'Color','y','FontSize',16)
    hold off
    pause(.001)
