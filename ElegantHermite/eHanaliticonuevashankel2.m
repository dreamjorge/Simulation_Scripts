...
plot(z/(zl/2),((1/m11zxo)*z+sigmaeHx(1))/(sqrt(2)*wo),'r','LineWidth',1.5)
plot(z/(zl/2),((1/m12zxo)*z+sigmaeHx(1))/(sqrt(2)*wo),'r','LineWidth',1.5)
plot(z/(zl/2),((1/m21zxo)*z+sigmaeHx(1))/(sqrt(2)*wo),'c','LineWidth',1.5)
plot(z/(zl/2),((1/m22zxo)*z+sigmaeHx(1))/(sqrt(2)*wo),'c','LineWidth',1.5)
%graficando los rayos de las normales al frente de onda
plot(z/(zl/2),(rxz11)/(sqrt(2)*wo),'b','LineWidth',1.5)
plot(z/(zl/2),(rxz12)/(sqrt(2)*wo),'b','LineWidth',1.5)
plot(z/(zl/2),(rxz21)/(sqrt(2)*wo),'m','LineWidth',1.5)
plot(z/(zl/2),(rxz22)/(sqrt(2)*wo),'m','LineWidth',1.5)
