...
for jj = 1 : numel(zi)
  ...
  % set(gca,'FontSize',18);
  export_fig(['eHermite',textdis{jj}],'-png','-transparent')
...
for z_index = 1:length(z)
  ...
  plotOpticalField(x,x,abs(g).^2,mapgreen,'microns','microns');
  hold on
...
plot(z/RayleighDistance,-HPz.HermiteWaistX/(2*InitialWaist),'-.','Linewidth',2,'Color','r')
hold off
export_fig('eHermiteLateralYRays','-png','-transparent')